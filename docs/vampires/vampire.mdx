...
Additional information on this role is available on the [Unofficial H2P Wiki](https://unofficialhowtoplay.co.uk/index.php/Vampire). Note: the unofficial wiki may contain inaccurate or outdated content.
:::
