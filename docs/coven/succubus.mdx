...
- The Omegawolf, Vampire, and Vampire Master are immune to the Succubus
...
- The Succubus can manipulate players into targeting either living or dead players. The Gravedigger cannot learn the role of a living player, but the Seer can learn the alignment of a dead player.
...
- If the Succubus tries to redirect the killing wolf, while the killing wolf is being lured by the Shaman's totem, the Shaman's ability dominates.
...
Additional information on this role is available on the <a href="https://unofficialhowtoplay.co.uk/index.php/Succubus" target="_blank" rel="noopener noreferrer">Unofficial H2P Wiki</a>. Note: the unofficial wiki may contain inaccurate or outdated content.
:::
