...
name: Strongman
menu: The Village
route: guides/roles/Strongman
---

# Strongman

The Strongman can cause a village win if they are the only village member left alive againt a single evil. Otherwise, they act as a normal villager.
