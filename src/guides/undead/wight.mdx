...
The Wight is a member of the Undead. They have no abilities. They are
equivalent to the role 'Villager' except Undead-aligned.
...
## Notes on the Wight
  ...
  - If a witchcraft using Undead role (such as Banshee or Necromancer)
    is purged or purified they will become a Wight
